...
?>
    ...
    <body>
        ...
        <div class="header">
            ...
            <p>Here you can unban and delete users</p>
        ...
        <div class="row">
            ...
            <div class="leftcolumn">
                ...
                <div class="card">
                    ...
                    $action = "SELECT * from users WHERE status='off'";
                    ...
                    for ($i = 0; $i <= $size - 1; $i++) {
                        ...
                        echo "<a href='alter.php?id=$id'>Edit</a>  ---  <a href='delete.php?id=$id'> Delete</a> --- <a href='unban.php?id=$id'> Unban</a>";
                        echo "<br> <br><br>";
                    }
                    ?>
                </div>
